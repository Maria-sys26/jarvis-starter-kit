...
Ce workspace est le Jarvis personnel de Mariam. Il a été créé avec le Jarvis Starter Kit pour servir d'assistant IA personnel au quotidien.
...
Je m'appelle Mariam et je vis à Sherbrooke au Canada. Je suis en phase de transition : je termine mon ASP en secrétariat médical en novembre 2026, je travaille comme associée aux services spéciaux chez Home Depot depuis janvier 2026, et je construis en parallèle mon agence d'automatisation IA pour agents immobiliers.

Je suis aussi créatrice de contenu sur deux fronts : fitness et beauté sur Instagram, et automatisation IA sur YouTube.

Mes objectifs prioritaires d'ici fin 2026 : suivre une formation IA complète, signer mes 2 premiers clients, et viser 10 000 $ de revenu mensuel.

À long terme (2027-2029), je veux faire de mon agence d'automatisation IA mon activité principale, déménager en Alberta, vivre en mode freelance avec liberté géographique, viser 50 000 $ de revenu mensuel, et construire ma vie de famille.

Le domaine où j'ai besoin du plus d'aide en ce moment : la stratégie business (clarifier mon offre et ma plus-value pour les agents immobiliers), puis la recherche et l'analyse d'information pour trouver la bonne formation, le bon mentor et les bons outils.
